            ...
            switch (amountRect) {
                case 0 -> {
                    ...
                    Rectangle rectResult = new SegmentedRegions2()
                            .getSegmentedRegionWxH_XxY(
                                    Rect1920x1080.LOCATIONSYMBOL_WIDTH, Rect1920x1080.LOCATIONSYMBOL_HEIGHT,
                                    Rect1920x1080.LOCATIONSYMBOL_X, Rect1920x1080.LOCATIONSYMBOL_Y);
                ...
                case 1 -> {
                    ...
                    Rectangle rectResult = new SegmentedRegions2()
                            .getSegmentedRegion_2WxH_2Xx2Y(
                                    Rect1920x1080.MININGBOT1_1_WIDTH,
                                    Rect1920x1080.MININGBOT1_2_WIDTH, Rect1920x1080.MININGBOT1_HEIGHT,
                                    Rect1920x1080.MININGBOT1_X_BLOCKSCREEN, Rect1920x1080.MININGBOT1_X2_BLOCKSCREEN,
                                    Rect1920x1080.MININGBOT1_Y_BLOCKSCREEN, Rect1920x1080.MININGBOT1_Y2_BLOCKSCREEN);
