...
public class ExtractOre implements VerifyRectangle {
    ...
    private static final int TIMETOWAIT_TOBEFILLED_MS = 1910000;
    private static final int TIMETOWAIT_CANNON_MS = 1904000;
        ...
        while (this.amountRect < SWITCHFLAG) {
            ...
            switch (this.amountRect) {
                ...
                case 2 -> {
                    ...
                    Thread.sleep(10000); // time to wait Strip Miner 1 (Average 30km - 15km cannon strip minner)
